...
public class RequstClient {
	 ...
	 * @param mHandler
	 */
	public static void doRegedit(String LoginPhone, String LoginPwd,
	 ...
	 * @param mHandler
	 */
	public static void getRegeditCode(String Phone, String code,
			AsyncHttpResponseHandler mHandler) {
		RequestParams params = new RequestParams();
	 ...
	 * @param mHandler
	 */
	public static void getPasswordCode(String Phone, String code,
			AsyncHttpResponseHandler mHandler) {
		RequestParams params = new RequestParams();
		params.put("Phone", Phone);
		params.put("Code", code);
	 ...
	 * @param mHandler
	 */
	public static void wangJPwd(String Phone, String Pwd,
			AsyncHttpResponseHandler mHandler) {
