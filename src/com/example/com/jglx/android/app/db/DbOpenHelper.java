...
public class DbOpenHelper extends SQLiteOpenHelper {
	...
	private static String getUserDatabaseName() {
		String id = LXApplication.getLocalUserInfo(mContext).UserID;
		return "linxin7" + id + ".db";
	}
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		// }
		// if (oldVersion ==7) {
		// db.execSQL("ALTER TABLE " + UserDao.TABLE_PUSH + " ADD COLUMN "
		// + UserDao.PUSH_DETAIL + " TEXT ;");
		// }
		// 升级\增加字段等
		// if (oldVersion < 2) {
		// db.execSQL("ALTER TABLE " + UserDao.TABLE_USER + " ADD COLUMN "
