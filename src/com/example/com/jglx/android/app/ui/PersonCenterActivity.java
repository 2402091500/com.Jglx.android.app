...
public class PersonCenterActivity extends BaseFragmentActivity implements
	...
	private void initView() {
		...
		findViewById(R.id.personCenter_msgLayout).setOnClickListener(
				onLayoutClick);
		mScrollView = (CustomScrollView) findViewById(R.id.personCenter_scrollView);
	...
	private void initData() {
		manager = LXDBManager.getInstance(PersonCenterActivity.this);
		...
		// offset = (AppUtil.screenWidth / 3 - AppUtil.screenWidth / 3) / 2;//
		// 计算偏移量
