...
public class GroupDetailActivity extends BaseActivity {
	...
	private void initView() {
		...
		if (LXApplication.mUserInfo.AuditingState == 3) {
			isGroupM = true;
	...
	private void initData() {
		setTitleTextRightText("", LXApplication.mUserInfo.BuildingName, "",
				true);
		mNameTv.setText(LXApplication.mUserInfo.BuildingName);
					...
					public void onSuccess(int statusCode, String content) {
						...
						try {
							...
							if (list != null && list.size() > 0) {
								...
								list2.add(0, LXApplication.mUserInfo);
								if (list.size() > 6) {
	...
	public void onClick(View arg0) {
		...
		case R.id.groupDetail_managerTv:// 申请为管理员\禁言
			if (isGroupM) {
				...
				if (LXApplication.mUserInfo.AuditingState == 0
