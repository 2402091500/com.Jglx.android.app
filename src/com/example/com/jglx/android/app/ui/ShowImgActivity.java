...
public class ShowImgActivity extends Activity {
	...
	private int curImg;
	private RetangleImageView[] imageViews;
	...
	private void initData() {
		...
		imageViews = new RetangleImageView[imgSize];
	...
	private Handler messageHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case 0:
				...
				// Toast.makeText(ShowImgActivity.this, "无法链接网络！",
				// Toast.LENGTH_SHORT).show();
				Log.e("保存图片失败-----------", mSaveMessage);
				break;
			case 1:
				Toast.makeText(ShowImgActivity.this, "图片已保存", Toast.LENGTH_LONG)
						.show();
				break;
			case 2:
				Toast.makeText(ShowImgActivity.this, mSaveMessage,
						Toast.LENGTH_SHORT).show();
				Log.e("保存图片失败-----------", mSaveMessage);
				// Toast.makeText(ShowImgActivity.this, "图片保存失败！",
				// Toast.LENGTH_SHORT).show();
				break;
