package com.example.com.jglx.android.app.city;
...
import com.example.com.jglx.android.app.city.MyLetterListView.OnTouchingLetterChangedListener;

public class Fuwu_city extends BaseActivity implements OnScrollListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setActiviyContextView(R.layout.a_city_to_fuwu);
		setTitleTextRightText("", "切换城市", "确定", true);
		...
		sh = (EditText) findViewById(R.id.city_searchEdt);
	...
	private class ResultListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.a_list_item, null);
	...
	public class ListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (viewType == 0) { // ��λ
				convertView = inflater.inflate(R.layout.a_frist_list_item, null);
				...
				convertView = inflater.inflate(R.layout.a_recent_city, null);
				...
				convertView = inflater.inflate(R.layout.a_total_item, null);
			} else {
				if (convertView == null) {
					convertView = inflater.inflate(R.layout.a_list_item, null);
	...
	class HotCityAdapter extends BaseAdapter {
		...
		@Override
		public View getView(int position, View convertView, ViewGroup parent) {
			convertView = inflater.inflate(R.layout.a_item_city, null);
	...
	private void initOverlay() {
		...
		overlay = (TextView) inflater.inflate(R.layout.a_overlay, null);
